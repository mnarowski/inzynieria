...
COPY album (id_album, name, id_user, id_trip) FROM stdin;
\.
...
1	Syrenka	Warszawa	12	25	Polska	Warszawska	3000
\.
...
COPY photo (id_photo, name, filelocation, datecreated, description, id_album) FROM stdin;
\.
...
2	1	Wycieczka do warszawy	12	1	1	0	Standard	Samochód	1
\.
...
12	system	kowalski	2012-01-05	root	63a9f0ea7bb98050796b649e85481845	0	1
\.
...
--
-- Name: fki_id_trip_fkx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX fki_id_trip_fkx ON album USING btree (id_trip);


--
-- Name: fki_id_user_fkx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX fki_id_user_fkx ON album USING btree (id_user);
...
--
-- Name: id_trip_fkx; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY album
    ADD CONSTRAINT id_trip_fkx FOREIGN KEY (id_trip) REFERENCES trip(id_trip) ON DELETE CASCADE;


--
-- Name: id_user_fkx; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY album
    ADD CONSTRAINT id_user_fkx FOREIGN KEY (id_user) REFERENCES "user"(id_user) ON DELETE CASCADE;
